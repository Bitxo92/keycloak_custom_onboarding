<script lang="ts">
	...
	// Fallback: Use Keycloak's login page
...
<div class="flex h-screen w-screen items-center justify-center">
	<Card.Root class="w-full max-w-sm">
		...
		<Card.Footer class="flex-col gap-2">
			<Button onclick={handleCustomLogin} class="w-full" disabled={isLoading}>
			...
			<Button variant="outline" class="w-full" onclick={handleKeycloakLogin} disabled={isLoading}>
